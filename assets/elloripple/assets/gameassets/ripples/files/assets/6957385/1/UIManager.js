...
UIManager.prototype.initialize =  function(){
            ...
            this.camefollow = camera.script.CameraFollow;
           ...
           //                  "</div>"+
           //                  "<div id = 'uiend'>"+
           //                  "<button id = 'loadscene'>start</button>"+
           //                  "</div>"+
           //                  "<p id = 'score'>0</p>"+
           ...
           //                  "#uiend{display:none;}"+   
           //                  "#loadscene { position:absolute;left:38%;top:60%; width:24%;height:auto;}"+
